...
fetch:
	...
	curl https://raw.githubusercontent.com/metallb/metallb/master/manifests/namespace.yaml > ${CHART_DIR}/templates/namespace.yaml
	curl https://raw.githubusercontent.com/metallb/metallb/master/manifests/metallb.yaml > ${CHART_DIR}/templates/resources.yaml
